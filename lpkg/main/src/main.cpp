...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        options.add_options()
            ...
            ("no-hooks", get_string("info.no_hooks_desc"), cxxopts::value<bool>()->default_value("false"))
            ("no-deps", get_string("info.no_deps_desc"), cxxopts::value<bool>()->default_value("false"))
