...
> [!WARNING]
> 这个项目的绝大部分源码使用AI模型生成。
> 虽然这不意味着其代码质量低下（有人工审核以及大量测试兜底），但是可能留下部分注释/文档痕迹。
> 比如"用户要求..." "0.18修复" 这种无效注释。这属于文档问题而非代码质量问题，如果你遇到，请提issue或者提交PR解决。
> 至于"AI Slop"这种偏见，并不能直接概括LankeOS。其更多是大量使用AI进行编写和维护而不是纯粹的放任代码堆积不管的屎山。
